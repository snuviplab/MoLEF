# from https://github.com/liudaizong/CSMGAN
...
from modules.csmgan.tanh_attention import TanhAttention
from modules.csmgan.dynamic_rnn import DynamicGRU
from modules.csmgan.ConvGRU import ConvGRUCell
from modules.csmgan.Coattention import CoAttention, CoAttention_intra
from modules.csmgan.multihead_attention import MultiHeadAttention
from modules.csmgan.position import RelTemporalEncoding
...
class SentenceEncoder(nn.Module):
    ...
    def forward(self, x, mask, node_pos, node_mask, adj_mat):
        ...
        phrase = torch.squeeze(self.max_pool(torch.cat((unigrams, bigrams, trigrams), 2)),dim=2)
    ...
    def forward(self, frames, frame_mask, words, word_mask,
        ...
        if not self.training:
            ...
            if self.args.dataset in ['Tacos', 'Charades'] :
                ...
                loss = cls_loss + 1e-3 * reg_loss #1e-3 5e-3
        return refine_box, loss, predict_flatten #, predict_flatten, a1, a2
