# from https://github.com/sunoh-kim/PLRN

import os
from collections import OrderedDict

from modules.plrn import building_blocks as bb
from modules.plrn.abstract_network import AbstractNetwork
from modules.plrn.utils import io_utils, net_utils, vis_utils
...
class Model(AbstractNetwork):
    ...
    def _build_network(self):
        ...
        self.use_cwr_loss = getattr(mconfig, "use_center_width_regression_loss", True)
    ...
    def visualize(self, vis_inps, vis_gt, prefix):
        ...
        vis_utils.visualize_Model(self.config, vis_data, self.itow, prefix)
