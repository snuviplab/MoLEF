# from https://github.com/K-Nick/MS-DETR
...
from modules.msdetr.kn_util.basic import registry
from modules.msdetr.backbone.segformerx import SegFormerXFPN, SegFormerX
from modules.msdetr.kn_util.ms_pooler import MultiScaleRoIAlign1D
from modules.msdetr.kn_util.misc import cw2se, calc_iou
from modules.msdetr.kn_util.loss import l1_loss, iou_loss
from modules.msdetr.kn_util.nn_utils.layers import MLP
from modules.msdetr.kn_util.nn_utils import clones
from modules.msdetr.kn_util.nn_utils.math import inverse_sigmoid_torch, gaussian_torch
from modules.msdetr.kn_util.basic import registry, global_get
from torchvision.ops import sigmoid_focal_loss
from modules.msdetr.kn_util.nn_utils.init import init_module
import copy
import os
from modules.msdetr.kn_util.basic import eval_env
...
class Model(nn.Module):
    ...
    def compute_loss(self, proposal_lvls_group, score_lvls_group, stage_logits, text_logits, word_mask, word_label, gt):
        ...
        # text loss
        #word_label = torch.permute(word_label, (1, 2, 0))
        #word_mask = torch.permute(word_mask, (1, 2, 0))
        # word_label = word_label.squeeze(2)
