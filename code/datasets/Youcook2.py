...
class Youcook2(Dataset):
    def __init__(self, model_name, feature_path, data_path, word2vec, max_num_frames, max_num_words, max_num_nodes, is_training, is_adj, vocab_size, with_max_IoU=-float('inf')):
        ...
        self.anchors = generate_anchors(dataset='Youcook2')
        ...
        # cal words id 
        self.vocab = load_pkl(file_path="../../data/activity/you_glove.pkl")
    ...
    def __getitem__(self, ind):
        ...
        # video feature
        vid_feats = load_feature(os.path.join(self.feature_path, '%s.npy'%vid), dataset='Youcook2')
        ...
        if self.model_name == 'tga':
            seg_size = int(fps * 19.63) // 2 # average moment length of YouCook2 19.63
        ...
        if self.is_adj != False :  #  ianet, csmgan use this setting
            ...
            adj_mat[adj_mat < self.is_adj * max_IoU] = 0.0   # ianet : self.is_adj = 0.45, csmgan : self.is_adj = 0.3
